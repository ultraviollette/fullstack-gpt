...
with st.sidebar:
    ...
    st.markdown(
        """
        [GitHub Repo Link](https://github.com/ultraviollette/fullstack-gpt)
        """
    )
...
if file:
    # File uploaded, proceed with RAG
    ...
    st.markdown(
        """
            ### Upload your documents on the sidebar and ask questions about them!
        """
    )
    st.session_state["messages"] = []